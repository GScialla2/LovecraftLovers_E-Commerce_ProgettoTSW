...
public class MaterialeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(materiale!=null)
        {
            ...
            {
                prodottiMateriale = ProdottoDAO.doRetriveMaterialeActionFigure(materiale);
            }
            else if(mat.equalsIgnoreCase("appoggio"))
            {
                prodottiMateriale=ProdottoDAO.doRetriveMaterialeAppoggio(materiale);
            }
            else if(mat.equalsIgnoreCase("clothes"))
            {
                prodottiMateriale=ProdottoDAO.doRetriveMaterialeOcchiPupazzo(materiale);
            }
